defmodule AccountingSystem.Repo.Migrations.CreateTableAuxiliaries20204 do
  use Ecto.Migration

  def change do
    create table(:auxiliaries, prefix: :period_2020_4) do
      ...
      add :policy_id, references(:policies, prefix: :period_2020_4)

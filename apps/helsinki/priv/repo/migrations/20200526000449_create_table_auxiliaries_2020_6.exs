defmodule AccountingSystem.Repo.Migrations.CreateTableAuxiliaries20206 do
  use Ecto.Migration

  def change do
    create table(:auxiliaries, prefix: :period_2020_6) do
      ...
      add :policy_id, references(:policies, prefix: :period_2020_6)

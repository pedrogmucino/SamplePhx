defmodule AccountingSystem.Repo.Migrations.CreateTableAuxiliaries20203 do
  use Ecto.Migration

  def change do
    create table(:auxiliaries, prefix: :period_2020_3) do
      ...
      add :policy_id, references(:policies, prefix: :period_2020_3)
      timestamps()
    end
  end
end

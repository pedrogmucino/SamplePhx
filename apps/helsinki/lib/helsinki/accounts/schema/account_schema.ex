defmodule AccountingSystem.AccountSchema do
  ...
  def changeset(account, attrs) do
    account
    |> cast(attrs, [:code, :status, :type, :name, :is_departamental, :parent_account, :root_account, :character, :group_code, :uuid_voucher, :payment_method, :apply_to, :third_party_prosecutor, :third_party_op, :apply_third_party_to])

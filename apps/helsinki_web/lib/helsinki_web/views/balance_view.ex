defmodule AccountingSystemWeb.BalanceView do
  use AccountingSystemWeb, :view
end

defmodule AccountingSystemWeb.BalanceLiveView do
  use Phoenix.LiveView

  def render(assigns) do
    Phoenix.View.render(AccountingSystemWeb.BalanceView, "index_balance.html", assigns)
  end

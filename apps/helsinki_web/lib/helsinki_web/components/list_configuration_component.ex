defmodule AccountingSystemWeb.ListConfigurationComponent do
  @moduledoc """
  Componente de listado de configuraciones de Cuenta
  """
  ...
  def render(assigns) do
    ...
    <div class="w-1/2 px-2 mt-2">
      <button phx-click="create_new" phx-value-id="xxx" phx-target="#structure_list" class="py-2 bg-teal-500 hover:bg-teal-400 text-white items-center inline-flex font-bold rounded text-sm w-full ">

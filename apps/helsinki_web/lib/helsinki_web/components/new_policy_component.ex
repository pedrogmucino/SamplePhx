                      ...
                      <%= for item <- Enum.reverse(@arr) do %>
                        <div class="w-full inline-flex items-center gap-4"> <!-------Este es el div que se va a dividir en 3---->
                          ...
                          <div class="w-1/6 text-right">
                            <button <%= if !@status, do: 'disabled' %> phx-click="edit_aux" value="<%=item.id%>" phx-target="#one" class="<%= if !@status, do: 'cursor-not-allowed' %> bg-teal-500 text-white text-center hover:bg-teal-400 border rounded">
                            ...
                            <button <%= if !@status, do: 'disabled' %> phx-click="delete_aux" value="<%=item.id%>" phx-target="#one" class="<%= if !@status, do: 'cursor-not-allowed' %> bg-red-500 text-white text-left hover:bg-red-400 border rounded">
